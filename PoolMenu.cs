...
namespace VRCBilliards
{
    ...
    public class PoolMenu : UdonSharpBehaviour
    {
        ...
        public FetchWinner fetchWinnerScript;     // Pool Tournament addition
        ...
        public void Start()
        {   fetchWinnerScript = transform.parent.GetComponentInChildren<FetchWinner>(); // Pool Tournament addition
        ...
        public void _TeamWins(bool isTeam2)
        {
            ...
            else
            {
                if (isTeam2)
                {
                    ...
                    if (fetchWinnerScript !=null){
                    fetchWinnerScript.OnWinnerUpdate();
